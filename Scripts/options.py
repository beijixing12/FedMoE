...
def get_options(parser: ArgumentParser, reset_args=None):
    ...
    parser.add_argument('-d', '--dataset', type=str, choices=dataset, default='OLI')
    ...
    parser.add_argument('--num_runs', type=int, default=5,
                        help='Number of repeated training runs to execute')
    ...
    parser.add_argument('--zpd_tau', type=float, default=0.5)
    parser.add_argument('--num_exercises', type=int, default=None)
    parser.add_argument('--concept_exercise_map', type=str, default=None)
    parser.add_argument('--mastery_threshold', type=float, default=0.8)
